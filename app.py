...
model = None
grad_model = None
target_layer_name = None # Kept as placeholder but unused
...
def predict():
    ...
    try:
        ...
        # Predict
        gc.collect() # Force GC before heavy inference
        ...
        # Grad-CAM (Disabled/Removed for performance)
        heatmap_base64 = None
